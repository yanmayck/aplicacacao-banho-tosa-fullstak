                  ...
                  <Card key={groomer.id} className="overflow-hidden">
                    <div className="p-4">
                      <div className="flex justify-between items-start mb-3">
                        ...
                        <Badge
                                                    variant={groomer.status === "available" ? "success" : "secondary"}
                    ...
                    <div className="bg-muted px-4 py-2 border-t flex justify-end gap-2">
                      <Button 
                        size="sm" 
                        variant="outline"
            ...
            <table className="w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Total de Pontos</th>
